...
CREATE TABLE `raw_material` (
  ...
  `id_unit_sub` int(11) DEFAULT NULL,
  `isActive` bit(1) DEFAULT b'1',
  PRIMARY KEY (`id`),
  KEY `raw_material_ibfk_1` (`unit`),
  KEY `id_unit_sub` (`id_unit_sub`),
  CONSTRAINT `raw_material_ibfk_1` FOREIGN KEY (`unit`) REFERENCES `unit` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `raw_material_ibfk_2` FOREIGN KEY (`id_unit_sub`) REFERENCES `unit` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `raw_material` */

insert  into `raw_material`(`id`,`name`,`number`,`unit`,`id_unit_sub`,`isActive`) values (9,'Thịt Bò',65.5,29,30,''),(11,'Cá Trê',7.8,29,30,''),(12,'Thịt Ba Rọi',54.3,29,30,'');
...
insert  into `recipes`(`id`,`id_raw_material_id`,`id_service_id`,`id_unit_id`,`number`,`note`,`isActive`) values (3,9,5,30,500,NULL,''),(4,12,6,30,300,NULL,''),(5,11,5,30,100,NULL,''),(6,9,6,30,200,NULL,'');
...
insert  into `restaurant_info`(`id`,`name`,`phone`,`address`,`email`,`logo`,`hourReservationNomal`,`hourReservationParty`,`minuteWarning`) values (1,'Hương Biển 12','0977941517','Châu Thành A, Hậu Giang','huongbien@gmail.com','images/canh-cai-cuc-nau-tom.jpg',2,3,1);
