...
insert  into `discount`(`id`,`name`,`type`,`beginDate`,`endDate`,`conditions`,`valueInvoice`,`value`,`detail`,`isActive`) values (18,'Khuyến Mãi Tháng 3',0,'2014-03-10 13:35:00','2014-03-15 13:33:00',0,0,10,'','\0'),(19,'KM',1,'2014-03-11 20:10:00','2014-03-15 13:33:00',0,10000,50000,'','');
...
insert  into `invoice`(`id`,`id_table_reservation_id`,`id_staff_id`,`date`,`cost`,`discount`,`note`,`isActive`) values (11,NULL,1,'2014-03-12 13:02:54',-34000,50000,'','');
...
insert  into `raw_material`(`id`,`name`,`number`,`unit`,`isActive`) values (1,'Thịt Bò',3.491,11,''),(2,'Thịt Heo',3.598,11,''),(3,'Cá Hồi',0.5,8,''),(4,'Cá điêu hồng',10,11,''),(5,'Nem Chua',4,NULL,'\0'),(6,'Nem Chua',89,8,''),(7,'Nếp',9.5,11,''),(8,'Gạo Trắng',50,11,''),(9,'Mỡ Heo',10,11,''),(10,'Thịt Ba Rọi',3.8,11,''),(11,'Tôm Sú',3.4,11,''),(12,'Măng',3.8,11,''),(13,'Bia Sài Gòn Đỏ',45,3,'');
...
insert  into `recipes`(`id`,`id_raw_material_id`,`id_service_id`,`number`,`note`,`isActive`) values (2,6,25,11,NULL,''),(4,1,21,0.5,NULL,''),(8,2,21,0.01,NULL,''),(9,3,25,9,NULL,''),(11,7,23,0.4,NULL,''),(12,1,23,0.009,NULL,''),(13,2,23,0.002,NULL,''),(15,2,25,0.4,NULL,''),(16,7,25,0.1,NULL,''),(17,10,36,0.15,NULL,''),(18,11,36,0.2,NULL,''),(19,12,36,0.15,NULL,''),(20,13,37,1,NULL,''),(21,13,41,1,NULL,'');
...
insert  into `table`(`id`,`name`,`type`,`location`,`numOfChair`,`status`,`isActive`) values (111,'Bàn 1',1,1,10,4,''),(113,'Bàn 2',1,1,1,4,''),(114,'Bàn 3',1,1,1,4,''),(115,'Bàn 4',1,1,1,4,''),(116,'Bàn 5',1,1,1,4,''),(117,'Bàn 6',1,1,1,1,''),(118,'Bàn 7',1,1,1,1,''),(119,'Bàn 8',1,1,1,4,''),(120,'Bàn 9',1,1,1,1,''),(121,'Bàn 10',1,1,1,1,''),(122,'Bàn 11',1,1,1,1,''),(123,'Bàn 12',1,1,1,1,''),(124,'Bàn 13',1,1,1,1,''),(125,'Bàn 14',1,1,1,1,''),(126,'Bàn 15',1,1,1,1,''),(127,'Bàn 16',1,1,1,1,''),(128,'Bàn 17',1,1,1,1,''),(129,'Bàn 18',1,1,1,1,''),(130,'Bàn 19',1,1,1,1,''),(131,'Bàn 20',1,1,1,1,''),(132,'Bàn 21',1,1,1,1,''),(133,'Bàn 22',1,1,1,1,''),(134,'Bàn 23',1,1,1,1,''),(135,'Bàn 24',1,1,1,1,''),(136,'Bàn 25',1,1,1,1,'');
...
insert  into `table_reservation`(`id`,`id_customer_id`,`prepay`,`beginDate`,`endDate`,`status`,`party`,`isActive`) values (168,1,99000,'2014-03-12 20:01:24','2014-03-12 20:01:24','\0','','\0'),(169,10,90000,'2014-03-12 21:01:00','0000-00-00 00:00:00','\0','',''),(170,5,0,'2014-03-12 20:03:39','0000-00-00 00:00:00','\0','\0','');
...
insert  into `table_reservation_detail`(`id`,`id_table_id`,`id_table_reservation_id`,`isActive`) values (399,111,168,''),(400,113,168,''),(401,114,168,''),(402,115,168,''),(403,111,169,''),(404,113,169,''),(405,114,169,''),(406,115,169,''),(407,116,169,''),(408,119,170,'');
...
insert  into `table_service`(`id`,`id_table_reservation_id`,`id_service_id`,`id_service_cost_id`,`number`,`note`,`status`,`isActive`) values (102,169,41,16000,1,NULL,'',''),(103,169,37,16000,1,NULL,'','');
...
WHERE 
	...
	when 0 then /* khi ma khach hang va ma nhan vien khong duoc chon*/
			...
			AND (DATE(beginDate) BETWEEN DATE(dt1) AND DATE(dt2))
