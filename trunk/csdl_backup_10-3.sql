...
insert  into `discount`(`id`,`name`,`type`,`beginDate`,`endDate`,`conditions`,`valueInvoice`,`value`,`detail`,`isActive`) values (18,'Khuyến Mãi Tháng 3',0,'2014-03-10 13:35:00','2014-03-15 13:33:00',0,0,10,'','');
...
insert  into `raw_material`(`id`,`name`,`number`,`unit`,`isActive`) values (1,'Thịt Bò',3.5,1,''),(2,'Thịt Heo',4,1,''),(3,'Cá Hồi',9.5,1,''),(4,'Cá điêu hồng',10,1,''),(5,'Nem Chua',4.5,1,'\0'),(6,'Nem Chua',100,8,''),(7,'vbnhgmn fnbgn',55.555,1,'');
...
CREATE TABLE `raw_material_invoice_detail` (
  ...
  CONSTRAINT `raw_material_invoice_detail_ibfk_3` FOREIGN KEY (`unit`) REFERENCES `unit` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
insert  into `recipes`(`id`,`id_raw_material_id`,`id_service_id`,`number`,`note`,`isActive`) values (1,1,25,7,NULL,'');
...
insert  into `service`(`id`,`name`,`type`,`unit`,`store`,`detail`,`image`,`isActive`) values (18,'Súp Chân Đà Điểu',9,'Bát',10,'','E:\\LUAN-VAN-2014\\image\\supchandadieu.jpg','\0'),(19,'Súp Thịt Đà Điểu',9,'Bát',8836,'','E:\\Menu 1.jpg',''),(20,'Súp Gân Đà Điểu',9,'Bát',7,'','D:\\Photos Center\\PHOTOS TONG HOP\\1.JPG',''),(21,'Salad Tổng Hợp',9,'Bát',0,'','E:\\LUAN-VAN-2014\\image\\salad.jpg',''),(23,'Nộm Bình Minh',9,'Đĩa',0,'','E:\\LUAN-VAN-2014\\image\\nombinhmonh.jpg',''),(25,'Nộm Gân Cần Guốc',9,'Đĩa',0,'','E:\\Menu 1.jpg',''),(26,'Bánh tét',9,'Đĩa',0,'fgbngfbgfhvccccccccccccccccccc','D:\\Photos Center\\phuoc2 (2).png',''),(30,'dàvs',11,'fsdf',3,'sdfdsf','C:\\Users\\nhphuoc\\Desktop\\av.png','\0'),(34,'uih   buu',17,'dk',10,'ng','D:\\Photos Center\\309949_205038499640604_88110147_n.jpg','\0');
...
insert  into `table_reservation`(`id`,`id_customer_id`,`beginDate`,`endDate`,`status`,`party`,`isActive`) values (98,NULL,'2014-03-10 13:33:25','0000-00-00 00:00:00','','\0','');
...
insert  into `table_reservation_detail`(`id`,`id_table_id`,`id_table_reservation_id`,`isActive`) values (299,9,98,'');
...
insert  into `table_service`(`id`,`id_table_reservation_id`,`id_service_id`,`id_service_cost_id`,`number`,`note`,`status`,`isActive`) values (52,98,19,2000000,8,NULL,'','');
...
insert  into `unit`(`id`,`name`,`isActive`) values (1,'Kg',''),(2,'g',''),(3,'Chai',''),(4,'Lon',''),(5,'Thùng',''),(6,'Ly',''),(7,'Chai 2','\0'),(8,'Cái','');
