...
insert  into `table_service`(`id`,`id_table_reservation_id`,`id_service_id`,`id_service_cost_id`,`number`,`note`,`status`,`isActive`) values (3,217,6,20000,90,NULL,'\0',''),(4,220,4,120000,9,NULL,'',''),(5,220,1,99999,27,NULL,'',''),(6,220,2,90000,18,NULL,'',''),(7,220,3,77777,18,NULL,'',''),(8,220,6,20000,9,NULL,'',''),(9,220,8,5000,18,NULL,'',''),(10,220,10,120000,19,NULL,'',''),(11,220,9,9000,9,NULL,'','');
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `service_add`(in _name varchar(50), in _type int, in _unit varchar(30), in _store int, _detail text)
BEGIN
	insert into service(service.name,service.type,service.unit,service.store,service.detail)
	values(_name,_type,_unit,_store,_detail);
END */$$
DELIMITER ;
